	...
	<div class="container-fluid header-cont" id='navHome-block'>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				<li class="nav-item" id='navTC-block'>
				...
				if(isset($_SESSION['login_user'])){
					if ($rs['chucvu'] == 0) {
						...
						echo '<li class="nav-item" id="navKH-block">
							...
							<li class="nav-item dropdown" id="navTHDS-block">
								<a class="nav-link" aria-current="page" href="chuathanhtoan.php" id="navTHDS">Tổng hợp đặt sân</a>
							</li>
...
$(document).ready(function() {
	...
	if (window.location.pathname == "/quanlysanbong/chuathanhtoan.php") {
		$("#navTHDS").css("color", "white");
		// $("#navKH-block").css("background-image", "linear-gradient(to right, #04be12,#32dc3f)");
	}
});
